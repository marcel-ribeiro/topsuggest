/**
 * @ngdoc
 * @name app.components.sections.expert-questionnaire.api.js
 * @description "This section is responsible for the page that displays the questionnaire about one specific category "
 */
'use strict';
...
angular.module('app.components.sections.expert-questionnaire.api', [
  ...
  'app.components.sections.expert-questionnaire.display-question-single-choice.api'
]);